                    ...
                    <div class="swiper sliderFeaturedPosts">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('{{ asset('frontEndAsset') }}/assets/img/post-slide-1.jpg');">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('{{ asset('frontEndAsset') }}/assets/img/post-slide-2.jpg');">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('{{ asset('frontEndAsset') }}/assets/img/post-slide-3.jpg');">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('{{ asset('frontEndAsset') }}/assets/img/post-slide-4.jpg');">
                                    <div class="img-bg-inner">
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img src="{{ asset('frontEndAsset') }}/assets/img/post-landscape-1.jpg" alt="" class="img-fluid"></a>
                        ...
                        <div class="col-lg-8 border-start custom-border">
                            @foreach($blogs as $blog)
                                <div class="post-entry-1">
                                    <a href="{{ route('post.detail',['slug'=>$blog->slug]) }}"><img src="{{ $blog->image }}" alt="blog-image" class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">{{ $blog->category_name }}</span> <span class="mx-1">&bullet;</span> <span>{{ $blog->date }}</span></div>
                                    <h2><a href="{{ route('post.detail',['slug'=>$blog->slug]) }}">{{ $blog->title }}</a></h2>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img src="{{ asset('frontEndAsset') }}/assets/img/post-landscape-4.jpg" alt="" class="img-fluid"></a>
